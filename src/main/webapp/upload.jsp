...
<body>
    ...
    <form name="userForm1" action="/knowledge_forum/file/upload2" enctype="multipart/form-data" method="post">
		<div id="newUpload1">
 	...
 	<form name="userForm2" action="/fileServer/upload_file" enctype="multipart/form-data" method="post">
 		<div id="newUpload2">
			<input type="file" name="file">
		</div>
